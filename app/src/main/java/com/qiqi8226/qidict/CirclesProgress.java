 ...
 * Time: 13:00
 */
public class CirclesProgress extends Drawable implements Drawable.Callback {
    ...
    private static final int ALPHA_OPAQUE = 200;
    private static final int ALPHA_ABOVE_DEFAULT = 180;
    ...
    public CirclesProgress(int[] colors) {
    ...
    public static class Builder {
        ...
        public Drawable build() {
            return new CirclesProgress(mColors);
        }
    }
}
